...
model_path = 'model___STRATEGY_1___40_epochs___4_convLayers___2024-11-29_090045.sav'
...
st.subheader('Cancer aca & scc  vs.  benign tissue')
...
if image_file is not None:
    ...
    if predicted_class == 0:  # 0 is for lung cancer aca or scc
